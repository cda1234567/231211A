...
namespace _231211A
{
    ...
    public partial class ReplenishmentDialog : Form
    {
        ...
        public ReplenishmentDialog(ReplenishmentItem item, int fileIndex)
        {
            ...
            InitializeComponent();
            // 延後綁定到 OnShown 事件，確保 SnapshotQty 已由外部設定
        }
        ...
        private void InitializeComponent()
        {
            ...
            lblDispatchAmount = new Label { Text = "本次補(發)料數量：", Location = new Point(20, 225), Size = new Size(150, 24) };
            ...
            btnOK = new Button { Text = "確認", Location = new Point(70, 290), Size = new Size(90, 35), BackColor = Color.FromArgb(40, 167, 69), ForeColor = Color.White, FlatStyle = FlatStyle.Flat };
            btnOK.Click += BtnOK_Click;
            this.Controls.Add(btnOK);
            btnSkip = new Button { Text = "跳過", Location = new Point(180, 290), Size = new Size(90, 35), BackColor = Color.FromArgb(108, 117, 125), ForeColor = Color.White, FlatStyle = FlatStyle.Flat };
            btnSkip.Click += BtnSkip_Click;
            this.Controls.Add(btnSkip);
            btnCancel = new Button { Text = "取消全部", Location = new Point(290, 290), Size = new Size(90, 35), BackColor = Color.FromArgb(73, 80, 87), ForeColor = Color.White, FlatStyle = FlatStyle.Flat };
